...
export default function MyCompletionsPage() {
  ...
  const handleRemoveCompletion = async (workflowId: string, workflowTitle: string) => {
                        ...
                        <DialogContent>
                          ...
                          <DialogFooter>
                            ...
                            <DialogTrigger asChild>
                              <Button
                                variant="secondary"
                                onClick={() => handleRemoveCompletion(completion.workflowId, completion.workflow.title)}
                                disabled={removingId === completion.workflowId}
                                className="gap-2"
                              >
                                {removingId === completion.workflowId ? (
