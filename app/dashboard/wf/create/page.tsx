  ...
  return (
    ...
    <section className="container mx-auto px-2 sm:px-4 py-4 sm:py-8 max-w-5xl">
      ...
      <p className="text-center text-muted-foreground text-sm sm:text-base mb-4 sm:mb-8 max-w-2xl mx-auto">
        Share your automation workflows with the community. Follow the steps below to create a comprehensive workflow.
      </p>
          ...
          <div className="space-y-6 sm:space-y-10 mb-6 sm:mb-10">
            ...
            <div className="relative">
              <div className="flex flex-wrap sm:flex-nowrap items-center gap-2 sm:gap-4 mb-3 sm:mb-6">
                <div className={`h-8 w-8 sm:h-10 sm:w-10 rounded-full flex items-center justify-center text-primary-foreground font-bold text-lg ${jsonUploaded ? 'bg-green-600' : 'bg-primary'}`}>
                  {jsonUploaded ? <CheckCircle2 className="h-5 w-5 sm:h-6 sm:w-6" /> : "1"}
                </div>
              ...
              <div className="pl-0 sm:pl-14">
                <div className={`bg-muted/20 p-3 sm:p-6 rounded-lg border ${jsonUploaded ? 'border-green-500/30' : 'border-muted'}`}>
            ...
            <div className={`relative transition-all duration-300 ${jsonUploaded ? 'opacity-100' : 'opacity-50 pointer-events-none'}`}>
              <div className="flex flex-wrap sm:flex-nowrap items-center gap-2 sm:gap-4 mb-3 sm:mb-6">
                <div className={`h-8 w-8 sm:h-10 sm:w-10 rounded-full bg-primary flex items-center justify-center text-primary-foreground font-bold text-lg ${!jsonUploaded && 'bg-muted text-muted-foreground'}`}>
                  {!jsonUploaded && <Lock className="h-3 w-3 sm:h-4 sm:w-4" />}
                  {jsonUploaded && "2"}
                </div>
                <h2 className="text-lg sm:text-xl font-semibold flex items-center gap-2">
                  <Upload className={`h-4 w-4 sm:h-5 sm:w-5 ${jsonUploaded ? 'text-primary' : 'text-muted-foreground'}`} />
              ...
              <div className="pl-0 sm:pl-14">
                <div className={`bg-muted/10 p-3 sm:p-6 rounded-lg border border-muted transition-all ${!jsonUploaded && 'blur-[2px]'}`}>
                  <p className="text-xs sm:text-sm text-muted-foreground mb-3 sm:mb-6">
            ...
            <div className={`relative transition-all duration-300 ${jsonUploaded ? 'opacity-100' : 'opacity-50 pointer-events-none'}`}>
              <div className="flex flex-wrap sm:flex-nowrap items-center gap-2 sm:gap-4 mb-3 sm:mb-6">
                ...
                <h2 className="text-lg sm:text-xl font-semibold flex items-center gap-2">
                  <BrainCircuit className={`h-4 w-4 sm:h-5 sm:w-5 ${jsonUploaded ? 'text-primary' : 'text-muted-foreground'}`} />
              ...
              <div className="pl-0 sm:pl-14">
                <div className={`bg-primary/5 p-3 sm:p-6 rounded-lg border border-primary/20 transition-all ${!jsonUploaded && 'blur-[2px]'}`}>
                  <p className="text-xs sm:text-sm text-muted-foreground mb-3 sm:mb-6">
            ...
            <div className={`relative transition-all duration-300 ${jsonUploaded ? 'opacity-100' : 'opacity-50 pointer-events-none'}`}>
              <div className="flex flex-wrap sm:flex-nowrap items-center gap-2 sm:gap-4 mb-3 sm:mb-6">
                ...
                <h2 className="text-lg sm:text-xl font-semibold flex items-center gap-2">
                  <PenLine className={`h-4 w-4 sm:h-5 sm:w-5 ${jsonUploaded ? 'text-primary' : 'text-muted-foreground'}`} />
            ...
            <div className={`relative transition-all duration-300 ${jsonUploaded ? 'opacity-100' : 'opacity-50 pointer-events-none'}`}>
              <div className="flex flex-wrap sm:flex-nowrap items-center gap-2 sm:gap-4 mb-3 sm:mb-6">
                ...
                <h2 className="text-lg sm:text-xl font-semibold">Publish Your Workflow</h2>
