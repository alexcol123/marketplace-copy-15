        ...
        <div className="relative container mx-auto px-4 py-16 lg:py-24">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <div className="flex flex-wrap justify-center gap-4 lg:gap-8 mb-8 text-sm">
              <Badge variant="outline" className="px-4 py-2 border-2 border-green-200 dark:border-green-700 bg-green-50 dark:bg-green-950/30 hover:bg-green-100 dark:hover:bg-green-950/50 transition-colors">
                <Timer className="h-4 w-4 text-green-600 dark:text-green-400 mr-2" />
                <span className="text-green-800 dark:text-green-200 font-medium">⚡ Average setup: 10 minutes</span>
              </Badge>
              <Badge variant="outline" className="px-4 py-2 border-2 border-blue-200 dark:border-blue-700 bg-blue-50 dark:bg-blue-950/30 hover:bg-blue-100 dark:hover:bg-blue-950/50 transition-colors">
                <Target className="h-4 w-4 text-blue-600 dark:text-blue-400 mr-2" />
                <span className="text-blue-800 dark:text-blue-200 font-medium">🎯 94% complete their first workflow</span>
              </Badge>
              <Badge variant="outline" className="px-4 py-2 border-2 border-purple-200 dark:border-purple-700 bg-purple-50 dark:bg-purple-950/30 hover:bg-purple-100 dark:hover:bg-purple-950/50 transition-colors">
                <Zap className="h-4 w-4 text-purple-600 dark:text-purple-400 mr-2" />
                <span className="text-purple-800 dark:text-purple-200 font-medium">💪 3 workflows mastered in first week</span>
              </Badge>
            </div>
            ...
            {/* CTA buttons - Reordered with primary first */}
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
              <Button
                asChild
                size="lg"
                className="group relative overflow-hidden bg-gradient-to-r from-primary via-primary to-primary/80 hover:from-primary/90 hover:via-primary hover:to-primary/70 shadow-xl hover:shadow-2xl hover:shadow-primary/25 transform hover:scale-105 transition-all duration-300 px-8 py-4 text-lg font-semibold"
              >
              ...
              <Button
                ...
                variant="outline"
                size="lg"
                className="group border-2 border-primary/30 hover:border-primary hover:bg-primary/5 px-8 py-4 text-lg font-semibold transition-all duration-300"
              >
                <a href="#workflows" className="flex items-center gap-2">
                  <ArrowDown className="h-5 w-5" />
                  <span>Browse Workflows Below</span>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
              <div className="bg-card/50 backdrop-blur-sm border border-primary/20 rounded-xl p-6 hover:border-primary/40 transition-colors">
                ...
                <div>
                  <div className="flex items-center gap-3 mb-6">
                    <div className="flex items-center gap-2">
                      ...
                      <h3 className="text-xl font-bold">🔥 Most Popular This Week</h3>
                    </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    {popularWorkflows.map((workflow) => (
                      <Card key={workflow.id} className="group overflow-hidden hover:shadow-lg transition-all duration-300 hover:border-primary/30">
                        <div className="relative">
                          ...
                          />
                          <Badge className="absolute top-2 right-2 bg-black/70 text-white hover:bg-black/80">
                ...
                <div>
                  <div className="flex items-center gap-3 mb-6">
                    <div className="flex items-center gap-2">
                      ...
                      <h3 className="text-xl font-bold">✨ Perfect for Beginners</h3>
                    </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    {beginnerWorkflows.map((workflow) => (
                      <Card key={workflow.id} className="group overflow-hidden hover:shadow-lg transition-all duration-300 hover:border-green-300">
                        <div className="relative">
                          <img 
                            src={workflow.workflowImage} 
                            alt={workflow.title}
                        ...
                        <div className="p-4 h-32 flex flex-col justify-between">
                          <div>
                            <h4 className="font-semibold text-sm mb-2 line-clamp-2 group-hover:text-green-600 transition-colors">
                              {workflow.title}
                            </h4>
                          </div>
                          <div className="flex items-center justify-between mt-auto">
        ...
        <div className="container mx-auto px-4 py-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <div className="bg-card border rounded-xl p-6 shadow-sm">
              ...
              <p className="text-sm mb-4 italic">
                "I've automated my entire sales process thanks to these
                workflows. Game changer for my productivity!"
              </p>
              <div className="flex items-center gap-3">
                <div className="w-8 h-8 bg-primary/20 rounded-full flex items-center justify-center text-sm font-semibold">
                  M
            ...
            <div className="bg-card border rounded-xl p-6 shadow-sm">
              ...
              <p className="text-sm mb-4 italic">
                "From zero to automation hero in just a few weeks. The hands-on
