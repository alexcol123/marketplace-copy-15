      ...
      <div className="text-center p-6 bg-gradient-to-br from-primary/5 via-transparent to-primary/5 rounded-xl border border-dashed border-primary/30">
        <div className="mb-4">
          ...
          <p className="text-sm text-muted-foreground mb-4">
            Sign in to mark workflows as completed and build your automation portfolio
          </p>
        </div>
        <Button 
          variant="default" 
        ...
        <div className={cn(
          ...
          <div className="relative p-6">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                <div className="relative">
                  <div className={cn(
                    ...
                    justCompleted && "animate-bounce shadow-2xl shadow-green-400/40"
                  )}>
              ...
              <Badge className={cn(
                "px-4 py-2 text-base font-semibold shadow-lg transition-all duration-300",
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">
                      Explore more workflows and level up your automation skills!
                    </p>
                  </div>
                </div>
    ...
    <div className="space-y-4">
      ...
      <div className="text-center p-4 bg-gradient-to-br from-primary/5 via-transparent to-primary/10 rounded-lg border border-primary/20">
        <div className="flex items-center justify-center gap-2 mb-2">
          ...
          <h3 className="font-semibold text-primary">Ready to Master This Workflow?</h3>
        </div>
