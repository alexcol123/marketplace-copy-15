...
export default function UnifiedStepCard({
  ...
  const getAIPrompts = () => {
    ...
    const prompts = {
      ...
      messages: [] as any[],
      text: "",
      nestedPrompts: [] as any[],
    };

    // Function to recursively search for prompts in nested objects
    const findPromptsRecursively = (obj: any, path: string = "") => {
    ...
    >
      ...
      <CardHeader className={cn("pb-3", colors.headerBg)}>
        <div className="flex items-start justify-between gap-3 mt-4">
          ...
          {/* Show Details Button - Always Present */}
                      ...
                      {prompts.nestedPrompts.length > 0 &&
                        ...
                        !prompts.text && (
                          <div className="space-y-3">
                            ...
                            {prompts.nestedPrompts.map((nestedPrompt, index) => (
                              <div
                                key={index}
                                className={cn(
                          ...
                          <div className="flex items-center justify-between">
                            <div className="flex items-center gap-2">
                              ...
                              <span className="text-xs font-medium text-purple-600">
                                Conversation ({prompts.messages.length} messages)
                              </span>
                            </div>
                            <Button
                              variant="ghost"
          ...
          {!hasParameters && (
            <>
              ...
              <div className="text-center py-6 text-muted-foreground">
                ...
                <p className="text-sm">
                  This node doesn't require any additional parameters to function.
                </p>
              </div>
            </>
          )}
